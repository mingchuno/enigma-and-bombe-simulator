  ...
  return (
    <div className="guide-content">
      <section>
        ...
        <p>
          Enigma turns a message into ciphertext using a secret configuration.
          The British Turing–Welchman Bombe helps work backwards from ciphertext
      ...
      <div className="guide-columns">
        <section>
          ...
          <ol>
            <li>
              <strong>Set the machine.</strong> Choose three distinct rotors,
              ring settings, starting windows, reflector, and optional plug
              pairs.
            </li>
            <li>
              <strong>Type a message.</strong> The rotors step before each
              letter. Follow the outward and returning signal at the right.
            </li>
            <li>
              <strong>Decipher it.</strong> Clear the input, keep the same
              starting settings, and enter the ciphertext. Encryption and
              decryption use the same operation.
            </li>
          </ol>
          <p>
            Input is converted to A–Z. Spaces, numbers, and punctuation are
            removed and do not advance the rotors. Editing input or settings
            replays the whole message from the starting windows.
          </p>
        </section>
        <section>
          ...
          <ol>
            <li>
              <strong>Supply an intercept and crib.</strong> A crib is a
              suspected fragment of plaintext. Align it with a zero-based
              offset.
            </li>
            <li>
              <strong>Declare what is known.</strong> This version requires
              rings and reflector. Search one rotor order or all 60, with a
              maximum plugboard cable count.
            </li>
            <li>
              <strong>Inspect candidates.</strong> The search tests starting
              windows and propagates reciprocal plugboard pairings. Surviving
              candidates are replayed through Enigma to verify the crib.
            </li>
          </ol>
          <p>
            Unknown plugboard letters are not recovered facts. Longer,
            well-connected cribs constrain more of the key. Stopping early,
            hitting the candidate limit, or exceeding a work budget leaves a
            partial search.
          </p>
        </section>
      </div>
      <section className="guide-feature">
        ...
        <p>
          Turnover is tested before movement. Ring settings change the internal
          wiring offset, while the visible notch-trigger letters stay the same.
        </p>
      </section>
      <section>
